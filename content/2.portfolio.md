...
I've been a full time Linux (and sometimes Mac) user for six years. For the first one or two I ran Ubuntu before
switching to Arch with i3wm. I'm very comfortable with a terminal and Linux troubleshooting.
...
These are some of the standalone projects I worked on in my own time.
